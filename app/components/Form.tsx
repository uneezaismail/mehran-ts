...
{isPopupVisible && (
      ...
      <div ref={formRef} style={{ display: isPopupVisible ? "block" : "none" }}>
        <div className="p-8 border space-y-10 rounded shadow-md w-[800px]">
          {/* Form content */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 "><span className="font-bold text-xl">School: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.school}</p></div>
            <div className="flex items-center gap-4 "><span className="font-bold text-xl">Contact No: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.contactNo}</p></div>
            <div className="flex items-center gap-4 "><span className="font-bold text-xl">Address: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.address}</p></div>
            <div className="flex items-center gap-4 "><span className="font-bold text-xl">District: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.district}</p></div>
          </div>
          ...
          <div className="space-y-4">
          <div className="flex items-center justify-between w-full"><div className="flex items-center gap-4 w-[50%]"><span className="font-medium text-xl">Name: </span><p className="border-b-2 border-b-black p-2  w-[70%] font-medium">{formData.name}</p></div>
            <div className="flex items-center gap-4 w-[50%]"><span className="font-medium text-xl">F.Name: </span><p className="border-b-2 border-b-black p-2  w-[70%] font-medium"> {formData.fatherName}</p></div></div>  
          
            <div className="flex items-center justify-between w-full">  <div className="flex items-center gap-4  w-[50%]"><span className="font-medium text-xl">Class: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.class}</p></div>
            <div className="flex items-center gap-4 w-[50%]"><span className="font-medium text-xl">School: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.school}</p></div> 
            </div>  
            
            <div className="flex items-center justify-between w-full"> <div className="flex items-center gap-4 w-[50%]"><span className="font-medium text-xl">Gender: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.gender}</p></div>
            <div className="flex items-center gap-4 w-[50%]"><span className="font-medium text-xl">Caste: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.caste}</p></div></div>
           
            <div className="flex items-center justify-between w-full"> <div className="flex items-center w-[50%] gap-4 "><span className="font-medium text-xl">Contact No: </span><p className="border-b-2 border-b-black p-2 w-[60%] font-medium"> {formData.contactNo}</p></div>
            <div className="flex items-center gap-4 w-[50%] "><span className="font-medium text-xl">Address: </span><p className="border-b-2 border-b-black p-2 w-[70%] font-medium"> {formData.address}</p></div></div>
            
            <div className="flex items-center gap-4"><p className="border-b-2 border-b-black py-2 w-full font-medium"></p></div>
